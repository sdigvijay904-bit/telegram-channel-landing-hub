...
export function TrustFooter({ channelTitle, onOpenAdmin }: TrustFooterProps) {
  ...
  return (
    <footer className="w-full mt-2 pt-2 border-t border-slate-200/80 text-center space-y-1.5 pb-1">
      {/* Trust Icons Row */}
      ...
      <div className="flex items-center justify-center space-x-2 text-[11px] text-slate-500 pt-0.5">
        <span 
          ...
          className="cursor-default select-none hover:text-slate-700 transition"
